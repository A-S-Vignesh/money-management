...
export default function BudgetsPage() {
  ...
  const periodFilteredBudgets =
    sortPeriodBy === "All"
      ? filteredBudgets
      : filteredBudgets.filter((b) => b.period === sortPeriodBy);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 lg:col-span-2 bg-white p-6 rounded-xl shadow-sm w-full border border-gray-100">
          ...
          <div className="bg-gray-50 rounded-lg h-64 px-4 py-2">
            {isEmpty ? (
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-600 text-sm text-nowrap">Sort by:</span>
