...
export default function BillReminders() {
  ...
  const features = [
    ...
    {
      icon: <CreditCard className="h-8 w-8 text-indigo-600 dark:text-indigo-300" />,
  ...
  const benefits = [
    ...
    {
      icon: <CheckCircle className="h-6 w-6 text-indigo-600 dark:text-indigo-300" />,
      title: "Never Miss a Payment",
      description:
        "92% of users report never paying a late fee after using our reminder system.",
    },
    {
      icon: <Clock className="h-6 w-6 text-indigo-600 dark:text-indigo-300" />,
      title: "Reduce Stress",
      description:
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-6">
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex justify-between items-center">
                    <div className="text-sm text-gray-500 dark:text-gray-400">Monthly total</div>
