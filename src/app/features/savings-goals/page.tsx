...
export default function SavingsGoals() {
  ...
  const features = [
    ...
    {
      icon: <Calendar className="h-8 w-8 text-indigo-600 dark:text-indigo-300" />,
      title: "Auto-Savings",
  ...
  const benefits = [
    {
      icon: <Gift className="h-6 w-6 text-indigo-600 dark:text-indigo-300" />,
      title: "Achieve Dreams Faster",
      description:
        "Users with specific savings goals reach them 3x faster than those without.",
    },
    {
      icon: <Home className="h-6 w-6 text-indigo-600 dark:text-indigo-300" />,
      title: "Financial Security",
      description:
        "Build emergency funds and save for major life events with confidence.",
    },
    {
      icon: <GraduationCap className="h-6 w-6 text-indigo-600 dark:text-indigo-300" />,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {goalCategories.map((category, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 hover:border-indigo-200 transition-all"
              >
                <div className="text-2xl mb-3">{category.icon}</div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">
                  {category.name}
                </h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">{category.examples}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl border border-gray-100 dark:border-gray-800"
              >
