...
function isItemActive(pathname: string, href?: Href): boolean {
  if (!href) return false;
  // `Href` can be a string OR a `{ pathname, params }` object — every
  // nav item in this drawer passes a string literal, so coerce.
  const hrefStr = typeof href === "string" ? href : href.pathname ?? "";
  if (hrefStr === "/(tabs)") return pathname === "/" || pathname === "/(tabs)";
